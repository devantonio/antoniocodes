...
require '../vendor/autoload.php';
		...
		$contact_name = filter_input(INPUT_POST,"name", FILTER_SANITIZE_STRING);
		 $contact_email  = trim(filter_input(INPUT_POST,"email", FILTER_SANITIZE_EMAIL));
...
$mail->setFrom($contact_email, $contact_name);
		...
		if ($mail->send()) {echo("Thank you <strong>$contact_name</strong> Your message has been sent. I will get back with you shortly.");}  
